...
export const OFFER_SIGNING_INSTRUCTIONS='Before beginning, sign this offer letter and its enclosed non-disclosure agreement (NDA), email both signed documents to contact@dmj.one, then enroll at https://timesheet.dmj.one to begin.';
...
export const DEFAULT_NDA_PARAGRAPHS:readonly string[]=[
 ...
 '**9. Acceptance and onboarding.** Read this NDA and the accompanying offer, sign both, and email the signed copies to contact@dmj.one. Then enroll at https://timesheet.dmj.one to begin. This NDA takes effect when signed by the recipient; any later changes to its specific obligations require written agreement, subject to applicable law.',
];
